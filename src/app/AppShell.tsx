                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <Link
                                    key={item.label}
                                    href={item.href}
                                    className={`group relative flex items-center gap-3 overflow-hidden rounded-2xl px-4 py-3.5 transition-all duration-300 ${active
                                            ? 'border border-cyan-300/20 bg-white/10 text-white'
                                            : 'border border-transparent text-slate-300 hover:border-cyan-300/20 hover:bg-white/5 hover:text-white'
                                        }`}
                                >
                                    <div
                                        className={`rounded-xl p-2 transition-all duration-300 ${active
