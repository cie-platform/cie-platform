...
const navItems = [
  ...
  { href: '/representantes', label: 'Representantes', icon: Users }, // 👈 ESTA LÍNEA
...
export default function RootLayout({
  ...
  return (
    <html lang="es" className="dark">
      <body className="min-h-screen overflow-hidden bg-transparent text-white">
        <div className="relative flex min-h-screen">
          ...
          <aside className="relative z-20 hidden w-72 shrink-0 border-r border-cyan-400/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.92),rgba(9,14,35,0.96))] backdrop-blur-2xl xl:flex xl:flex-col shadow-[inset_-1px_0_0_rgba(255,255,255,0.04)]">
            ...
            <div className="border-t border-white/10 p-4">
              <button className="group flex w-full items-center gap-3 rounded-2xl border border-red-500/10 bg-red-500/5 px-4 py-3 text-slate-300 transition-all duration-300 hover:border-red-400/20 hover:bg-red-500/10 hover:text-white">
                <div className="rounded-xl bg-red-500/10 p-2 text-red-300 transition-transform duration-300 group-hover:scale-110">
                  <LogOut size={18} />
                </div>
          ...
          <main className="relative z-10 flex min-h-screen flex-1 flex-col overflow-hidden">
              ...
              <div className="flex flex-col gap-4 px-6 py-5 lg:flex-row lg:items-center lg:justify-between xl:px-8">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                  <div className="relative w-full sm:w-[380px]">
                    ...
                    <input
                      type="search"
                      placeholder="Buscar alumnos, cursos, docentes o facturas..."
                  ...
                  <div className="flex items-center gap-3">
                    <button className="relative rounded-2xl border border-white/10 bg-white/5 p-3 text-slate-300 transition-all duration-300 hover:border-cyan-400/30 hover:bg-cyan-400/10 hover:text-cyan-300">
                      <Bell size={20} />
                    ...
                    <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-2.5">
                      ...
                      <div className="hidden sm:block">
                        <p className="text-sm font-bold text-white">Sabri Project</p>
            ...
            <section className="flex-1 overflow-y-auto px-6 py-6 xl:px-8">
